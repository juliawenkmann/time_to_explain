...
from tgnnexplainer import PROCESSED_DATA_DIR, EXPLAIN_INDEX_DIR
...
def load_tg_dataset(dataset_name):
    df = pd.read_csv(PROCESSED_DATA_DIR / f'ml_{dataset_name}.csv')
    edge_feats = np.load(PROCESSED_DATA_DIR / f'ml_{dataset_name}.npy')
    node_feats = np.load(PROCESSED_DATA_DIR / f'ml_{dataset_name}_node.npy')
...
if __name__ == '__main__':
    ...
    explainer_idx_dir = EXPLAIN_INDEX_DIR
    file = PROCESSED_DATA_DIR / f'ml_{args.d}.csv'
