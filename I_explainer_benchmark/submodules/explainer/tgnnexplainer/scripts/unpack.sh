...
if [ -n "$RES_ROOT" ] && [ -d "$RES_ROOT/resources" ]; then
    ...
    EXPLAINER_WEIGHTS="$RES_ROOT/resources/explainer/tgnnexplainer"
    RESULTS="$RES_ROOT/resources/results/tgnnexplainer"
    RESULTS_MCTS="$RES_ROOT/resources/results/tgnnexplainer/mcts_saved_dir"
else
