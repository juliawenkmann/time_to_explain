...
from .tgnn_paths import TGNNDatasetPaths, tgnn_dataset_paths
from .explain_index import generate_explain_index
from .tgnn_setup import setup_tgnn_data
from .validate import basic_stats
from .workflows import read_dataset_config
...
def prepare_tgnn_dataset(
    ...
    *,
    ...
    repo_root = (
        ...
        else find_repo_root(start=Path(__file__).resolve(), marker="I_explainer_benchmark")
    )
