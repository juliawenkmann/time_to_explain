...
from ..core.cli import find_repo_root, normalize_benchmark_root
from ..core.registry import get_dataset
from .io import export_tgn_csv
from .validate import basic_stats, verify_interactions
...
def prepare_dataset(
    *,
    ...
    root_dir = normalize_benchmark_root(root_dir, marker="I_explainer_benchmark")
    ...
    if visualize:
        ...
        try:
            from ..viz.visualization import visualize_to_files
