...
def _safe_to_device(obj, device: torch.device):
    """Best-effort device move for pathpyG objects across versions."""
...
def generate_connected_hub_chain_dataset(
    *,
    ...
    t_graph = pp.TemporalGraph.from_edge_list(tedges, device=device)
...
def load_temporal_clusters(
    *,
    ...
    if hasattr(data, "edge_index_higher_order"):
        ...
        if attach_stay_gt:
            from data.gt_stay import attach_stay_gt_to_data
    ...
    if attach_shuffle_gt:
        ...
        from data.gt_shuffle import attach_shuffle_gt_to_data
...
def load_temporal_clusters_connected(
    *,
    ...
    if hasattr(data, "edge_index_higher_order"):
        ...
        if attach_stay_gt:
            from data.gt_stay import attach_label_stay_gt_to_data
