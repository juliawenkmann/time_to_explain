...
class TGEventCandidatesExtractor:
    ...
    Args:
        ...
        events: DataFrame with at least columns [u, i, ts] in that order (as in your loaders)
    ...
    def __init__(self, *, model: Any, events, threshold_num: int = 50, keep_order: str = "last-N-then-sort",
